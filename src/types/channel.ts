import { TextChannel, AnyGuildChannel, Message } from 'eris'
import { Client } from '..'

const filter = (search: string) => {
  return (channel: TextChannel) => channel.name.toLowerCase() === search
}
...
class ChannelType {
  ...
  parse (value: string, msg: Message): AnyGuildChannel | string {
